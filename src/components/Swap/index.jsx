...
const VikingTokenPurchase = () => {
  ...
  return (
    <div className="flex flex-col items-center p-2 md:p-4 my-10">
      ...
      <div className="w-full h-full flex flex-col items-center gap-3">
        <div className="max-w-[430px] w-[90%] h-full px-4 py-5 bg-[#0d0805] border-[1px] rounded-lg border-[#f5f7fa08]">
          <div className="flex flex-row justify-between items-center">
            ...
            {swapToken ? <div onClick={() => changeToken()} className="justify-end gap-1 flex flex-row items-center cursor-pointer pr-1">
              <img src="../src/assets/header_logo2.png" alt="Viking icon" className="w-7 md:w-9" />
              <AiOutlineSwap className="" />
              <img src="../src/assets/STX_token.png" alt="STX icon" className="w-6 md:w-8" />
            </div>
              :
              <div onClick={() => changeToken()} className="justify-end gap-1 flex flex-row items-center cursor-pointer pr-1">
                <img src="../src/assets/STX_token.png" alt="STX icon" className="w-6 md:w-8" />
                <AiOutlineSwap className="" />
                <img src="../src/assets/header_logo2.png" alt="Viking icon" className="w-7 md:w-9" />
              </div>
          ...
          <div className="flex flex-col w-full border-[1px] border-[#f5f7fa08] bg-[#f5f7fa0a] rounded-xl my-1">
            <div className="w-full flex flex-row text-sm md:text-md font-medium items-center justify-between p-3 border-b-[#f5f7fa08] border-b-[1px]">
              <label
                htmlFor="stxAmount"
                className="block text-[#717179] "
              >
                Amount in Token:
              </label>
              <div className="flex flex-row items-center justify-end gap-3">
                {swapToken ?
                  <img src="../src/assets/header_logo2.png" alt="Viking icon" className="w-7 md:w-8" />
                  :
                  <img src="../src/assets/STX_token.png" alt="STX icon" className="w-6 md:w-8" />
                }
                <input
            ...
            <div className="w-full flex flex-row text-sm md:text-md font-medium items-center justify-between p-3 text-[#717179]">
              ...
              <div className="flex flex-row gap-2">
                <p> {swapBalance} </p>
                <div className="cursor-pointer text-[#f89728]">
                  Use Max
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col w-full border-[1px] border-[#f5f7fa08] bg-[#f5f7fa0a] rounded-xl my-1">
            <div onClick={() => changeToken()} className="w-8 h-8 md:w-10 md:h-10 flex flex-col border-1px border-[#0d0805] text-[#717179] rounded-lg bg-[#040505] justify-center items-center text-2xl absolute mt-[-18px] md:mt-[-24px] right-[45%] md:right-[49%] rotate-90 cursor-pointer">
              <AiOutlineSwap />
            </div>
            <div className="w-full flex flex-row text-sm md:text-md font-medium items-center justify-between p-3 border-b-[#f5f7fa08] border-b-[1px]">
              <label
